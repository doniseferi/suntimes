...
declare module "suntimes" {
    ...
    * @returns {number} The declination in degrees where north is a positive value and south is a negative value within a range of range of -23.45 and 23.45.
     */
    function getDeclinationOfTheSun(date: Date): number;
    /** @function
    * @description
    ...
    * suntimes.getHourAngleSinceNoon(new Date(2025, 0, 18), 51.477730, -12);
     */
    function getHourAngleSinceNoon(date: Date, latitude: number, angle: number): number;
    /** @function
    * @description
    ...
    * suntimes.getNoonHourAngle(new Date(2025, 0, 18), -0.010150);
     */
    function getNoonHourAngle(date: Date, longitude: number): number;
    /** @function
    * @description
    ...
    * suntimes.getSunriseDateTimeUtc(new Date(2032, 0, 1), 89.5250, -30.4500);
     */
    function getSunriseDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getSunsetDateTimeUtc(new Date(2032, 0, 1), 89.5250, -30.4500);
     */
    function getSunsetDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getCivilDawnEndDateTimeUtc(new Date(2032, 0, 1), 89.5250, -30.4500);
     */
    function getCivilDawnEndDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getCivilDawnStartDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getCivilDawnStartDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getNauticalDawnEndDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getNauticalDawnEndDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getNauticalDawnStartDateTimeUtc(new Date(2032, 0, 1), 89.5250, -30.4500);
     */
    function getNauticalDawnStartDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getAstronomicalDawnEndDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getAstronomicalDawnEndDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getAstronomicalDawnStartDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getAstronomicalDawnStartDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getAstronomicalDuskStartDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getAstronomicalDuskStartDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getAstronomicalDuskEndDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getAstronomicalDuskEndDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getNauticalDuskEndDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getNauticalDuskEndDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
    ...
    * suntimes.getNauticalDuskStartDateTimeUtc(new Date(2037, 7, 2), 71.980070, 102.474270);
     */
    function getNauticalDuskStartDateTimeUtc(date: Date, latitude: number, longitude: number): string;
    /** @function
    * @description
